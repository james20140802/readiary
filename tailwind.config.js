  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        note: ['1rem', { lineHeight: '1.75', fontWeight: '400' }],
        ...
        overline: [
          '0.875rem',
          { lineHeight: '1.375rem', fontWeight: '700', letterSpacing: '0.05em' },
        ],
        seal: ['0.875rem', { lineHeight: '1.375rem', fontWeight: '700', letterSpacing: '0.08em' }],
        ornament: ['0.75rem', { lineHeight: '1rem' }],
        quote: ['1.375rem', { lineHeight: '1.85', fontWeight: '400' }],
