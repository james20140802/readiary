    ...
    <Card className="mb-4" hoverable={false}>
      {entry ? (
        <div className="flex flex-col gap-1">
          <p className="text-caption text-ink-faint uppercase tracking-wide">📖 오늘 읽은 책</p>
          <h2 className="text-section-title text-ink">
            {entry.book.title}
          </h2>
          {entry.note && (
            <p className="mt-1 text-body-sm text-ink-sub italic line-clamp-2">
              &quot;{entry.note}&quot;
            </p>
          )}
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-caption text-ink-faint uppercase tracking-wide">🕐 오늘의 기록</p>
