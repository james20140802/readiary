...
export default async function Home() {
  ...
  return (
    <main className="relative text-foreground">
      <section className="sticky top-0 h-screen flex flex-col justify-center items-center px-6 text-center bg-paper">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <Link href="/login">
            <button className="px-6 py-3 rounded-md bg-primary hover:bg-primary/90 text-base font-medium text-black">
              로그인
            </button>
          </Link>
          <Link href="/signup">
