-- Match ECMAScript String.trim whitespace exactly, including NBSP and BOM.
-- Preserve existing execution grants and caller RLS.
...
returns jsonb language sql stable security invoker set search_path = '' as $$
  select case when count(*)=0 then null else jsonb_build_object(
    ...
    'entryCount',count(*),'quoteCount',count(*) filter(where nullif(btrim(e.quote, U&'\0009\000A\000B\000C\000D\0020\00A0\1680\2000\2001\2002\2003\2004\2005\2006\2007\2008\2009\200A\2028\2029\202F\205F\3000\FEFF'), '') is not null),
...
returns jsonb language sql stable security invoker set search_path = '' as $$
  with book as (
    ...
    where nullif(btrim(e.quote, U&'\0009\000A\000B\000C\000D\0020\00A0\1680\2000\2001\2002\2003\2004\2005\2006\2007\2008\2009\200A\2028\2029\202F\205F\3000\FEFF'), '') is not null and (not coalesce(p_public_only,false) or e.is_private=false)
  )
